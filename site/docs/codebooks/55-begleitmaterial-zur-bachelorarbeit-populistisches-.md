...
Dieses Projekt beinhaltet die Daten und das Codebuch für die Bachelorarbeit „Populistisches Wahlverhalten junger Erwachsener in Deutschland: Prädiktoren im Kontext der Einstellungs-Verhaltens-Beziehung“ (Chrysikakis, 2026). Der Datensatz (N=449) enthält unter anderem Daten zu folgendem: Wahlverhalten in der Bundestagswahl 2025, populistischen Einstellungen, politischer Selbstwirksamkeit, Subjektiver Norm, Schulnoten, Declinism und Relativer Deprivation sowie soziodemografische Daten. 
...
**Concepts:** populism, populist attitudes, electoral behavior, voting behavior, German federal election, political efficacy, subjective norms, relative deprivation, declinism, young adults
